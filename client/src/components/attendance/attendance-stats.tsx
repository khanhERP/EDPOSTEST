              ...
              {employeeStats.map(({ employee, totalDays, totalHours, overtimeHours, lateCount, absentCount, attendanceRate }) => (
                <div key={employee.id} className="border rounded-lg p-4">
                  <div className="flex justify-between items-start mb-3">
                    <div>
                      ...
                      <p className="text-sm text-gray-600">
                        {employee.role === 'manager' ? t('employees.roles.manager') : 
                         employee.role === 'admin' ? t('employees.roles.admin') : 
                  ...
                  <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-sm">
                    ...
                    <div>
                      <p className="text-gray-600">{t('attendance.totalHours')}</p>
                      <p className="font-semibold">{totalHours}{t('attendance.hours')}</p>
                    </div>
                    <div>
                      <p className="text-gray-600">{t('attendance.overtime')}</p>
