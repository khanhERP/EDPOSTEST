...
export function OrderManagement() {
  ...
  // Add global event listener for refreshing data
  useEffect(() => {
    const handleGlobalRefresh = async () => {
      console.log('🔄 Order Management: Received global refresh event');
      ...
      try {
        ...
        console.log('✅ Order Management: Global refresh completed');
      } catch (error) {
        console.error('❌ Order Management: Global refresh failed:', error);
      }
    };

    const handleCloseAllPopups = () => {
      console.log('🔴 Order Management: Closing all popups from global event');
      setShowReceiptModal(false);
      setSelectedReceipt(null);
      setOrderForPayment(null);
      setShowPaymentMethodModal(false);
    ...
    const handleReloadAllAPIs = async () => {
      console.log('🔄 Order Management: Reloading all APIs from global event');
      try {
        ...
        console.log('✅ Order Management: All APIs reloaded successfully');
      } catch (error) {
        console.error('❌ Order Management: Error reloading APIs:', error);
      }
    };
