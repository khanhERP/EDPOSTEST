            ...
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-normal mt-1">{t("reports.topProductsByQuantity") || `Top ${menuAnalysis.topSellingProducts.slice(0, 10).length} sản phẩm bán nhiều nhất`}</p>
                </div>
              </CardTitle>
            </CardHeader>
            ...
            <CardHeader className="pb-4">
              <CardTitle className="flex items-center gap-3 text-lg">
                ...
                <div>
                  ...
                  <p className="text-sm text-gray-500 font-normal mt-1">{t("reports.topProductsByRevenue") || `Top ${menuAnalysis.topRevenueProducts.slice(0, 10).length} sản phẩm doanh thu cao nhất`}</p>
                </div>
              </CardTitle>
            </CardHeader>
            <CardContent className="pt-0">
