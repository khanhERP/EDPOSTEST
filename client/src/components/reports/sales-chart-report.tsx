                ...
                onClick={() => {
                  const dataWithSummary = [
                    ...Object.entries(dailySales).map(([date, data]) => ({
                      ...
                      Thuế: formatCurrency(data.tax), // Corrected to display calculated tax
                    ...
                    // Add summary row
                    {
                      ...
                      ), // Corrected to display total calculated tax
                ...
                const dataWithSummary = [
                  ...allItemsFlat.map((item, index) => {
                    ...
                    return {
                      ...
                      "Thuế suất": formatCurrency(item.tax), // Corrected to display calculated tax
                  ...
                  // Add summary row
                  {
                    ...
                    "Thuế suất": formatCurrency(totalTax), // Corrected to display total calculated tax
                  ...
                  onClick={() => {
                    const dataWithSummary = [
                      ...data.map((item) => ({
                        ...
                        "Doanh thu": formatCurrency(item.revenue),
                        "Giảm giá": formatCurrency(item.discount),
                        Thuế: formatCurrency(item.tax), // Corrected to display calculated tax
                      ...
                      // Add summary row
                      {
                        ...
                        Thuế: formatCurrency(
                          data.reduce((sum, item) => sum + (item.tax || 0), 0),
                        ), // Corrected to display total calculated tax
