                                      ...
                                      (transaction: any) => {
                                        try {
                                          ...
                                          const employeeMatch = (() => {
                                            try {
                                              // Exact match first
                                              if (transactionEmployeeName === currentEmployeeName) {
                                                return true;
                                              }
                                              ...
                                              if (!safeCurrentEmployeeName || safeCurrentEmployeeName === "Unknown") {
                                                return orderEmployeeName === "Unknown";
                                              }
                                              ...
                                              if (orderEmployeeName && safeCurrentEmployeeName) {
                                                const searchTerm = safeCurrentEmployeeName.toLowerCase();
                                                const employeeTerm = orderEmployeeName.toLowerCase();

                                                if (employeeTerm.includes && typeof employeeTerm.includes === 'function') {
