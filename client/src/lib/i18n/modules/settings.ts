...
export const settingsTranslations: { [key: string]: SettingsTranslations } = {
  ...
  en: {
    ...
    einvoiceDesc: "Manage connections with electronic invoice service providers",
  ...
  vi: {
    ...
    einvoiceDesc: "Quản lý kết nối với các nhà cung cấp dịch vụ hóa đơn điện tử",
