...
export const reportsTranslations: { [key: string]: ReportsTranslations } = {
  ...
  vi: {
    ...
    inOutInventoryReport: "Báo cáo xuất nhập kho",
    detailedInOutInventoryReport: "Báo cáo xuất nhập kho chi tiết",
    disposalReport: "Báo cáo hủy bỏ",
    supplierReportByProduct: "Báo cáo nhà cung cấp theo sản phẩm",
    employeeCount: "Số lượng nhân viên",
    supplierCount: "Số lượng nhà cung cấp",
