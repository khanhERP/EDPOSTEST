...
export const reportsTranslations: { [key: string]: ReportsTranslations } = {
  ko: {
    ...
    customerSalesReportByProduct: "고객별 상품 판매 보고서",
  ...
  en: {
    ...
    customerSalesReportByProduct: "Customer Sales Report by Product",
    ...
    // Employee report specific
    employeeProfitReport: "Employee Profit Report",
    employeeProductSalesReport: "Employee Product Sales Report",
  ...
  vi: {
    ...
    customerSalesReportByProduct: "Báo cáo khách theo hàng bán",
    ...
    employeeProductSalesReport: "Báo cáo bán hàng sản phẩm theo nhân viên",
    employeeProductSales: "Bán hàng sản phẩm theo nhân viên"
  },
};
