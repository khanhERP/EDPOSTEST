...
export const reportsTranslations: { [key: string]: ReportsTranslations } = {
  ...
  vi: {
    ...
    salesChannelGrossProfit: "Tổng lợi nhuận",
    salesChannelFee: "Phí",
    ...
    totalChannels: "Tổng kênh bán hàng",
    ...
    // Pagination and table translations
    showEntries: "Hiển thị mục",
    entriesPerPage: "mục trên trang",
