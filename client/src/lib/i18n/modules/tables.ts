...
export const tablesTranslations: { [key: string]: TablesTranslations } = {
  ko: {
    ...
    capacityMinimum: "정원은 최소 1명 이상이어야 합니다",
    tableUpdateError: "테이블 수정 중 오류가 발생했습니다",
    ...
    taxRatePlaceholder: "세율을 입력하세요",
    stockPlaceholder: "재고를 입력하세요",
  ...
  vi: {
    ...
    taxRatePlaceholder: "Nhập thuế suất",
    pricePlaceholder: "Nhập giá",
  },
};