...
export const suppliersTranslations: { [key: string]: SuppliersTranslations } = {
  ...
  ko: {
    ...
    code: "코드",
    codePlaceholder: "공급업체 코드를 입력하세요",
    taxId: "사업자번호",
    taxIdPlaceholder: "사업자번호를 입력하세요",
    bankAccount: "은행계좌",
    bankAccountPlaceholder: "은행계좌를 입력하세요",
    cash: "현금",
    notes: "메모",
    notesPlaceholder: "메모를 입력하세요",
    status: "상태",
    createSuccess: "공급업체 추가 성공",
    createSuccessDesc: "공급업체가 성공적으로 추가되었습니다",
    createFailed: "공급업체 추가 실패",
    createFailedDesc: "공급업체 추가에 실패했습니다",
    updateSuccess: "공급업체 수정 성공",
    updateSuccessDesc: "공급업체가 성공적으로 수정되었습니다",
    updateFailed: "공급업체 수정 실패",
  ...
  vi: {
    ...
    status: "Trạng thái",
    createSuccess: "Thêm nhà cung cấp thành công",
    createSuccessDesc: "Nhà cung cấp đã được thêm thành công",
    createFailed: "Thêm nhà cung cấp thất bại",
    createFailedDesc: "Không thể thêm nhà cung cấp",
    ...
    requiredFields: "Vui lòng điền vào các trường bắt buộc",
  },
};