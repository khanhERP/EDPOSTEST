...
export const translations = {
  ko: {
    ...
    reports: {
      ...
      loadingData: "대시보드 데이터를 불러오는 중...",
      dashboardDescription: "선택한 기간의 운영 현황을 확인합니다.",
      startDate: "시작 날짜",
      endDate: "종료 날짜",
      refresh: "조회",
      periodRevenue: "기간 매출",
      orderCount: "주문 건수",
      averageOrderValue: "평균 주문가",
      customerCount: "고객 수",
      peakHour: "피크 시간",
      monthRevenue: "월 매출",
      monthAccumulated: "이번 달 누적",
      realTimeStatus: "실시간 현황",
      pendingOrders: "진행 중인 주문건",
  ...
  en: {
    ...
    employees: {
      ...
      addEmployeeHint:
        "Click the add employee button to register a new employee.",
    ...
    reports: {
      ...
      dashboardDescription:
        "View business performance for the selected   period.",
      startDate: "Start Date",
      endDate: "End Date",
      refresh: "Search",
      periodRevenue: "Revenue by Period",
      orderCount: "Order Count",
      averageOrderValue: "Average Order Value",
      customerCount: "Number of Customers",
      peakHour: "Peak Hour",
      monthRevenue: "Monthly Revenue",
      monthAccumulated: "Month-to-date Total",
    ...
    settings: {
      ...
      categoriesRedirect:
        "Category management is available in the Inventory page.",
      goToInventory: "Go to Inventory",
      employeeManagementDesc: "Register and manage employee information.",
      employeesRedirect:
        "Employee management is available in the Employees page.",
  ...
  vi: {
    ...
    reports: {
      ...
      dashboard: "Bảng điều khiển doanh thu",
      ...
      peakHour: "Khung giờ cao điểm",
      monthRevenue: "Doanh thu tháng",
      monthAccumulated: "Lũy kế trong tháng",
      realTimeStatus: "Tình trạng thực tế",
