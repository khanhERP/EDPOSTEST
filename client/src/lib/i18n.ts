...
const translations = {
  ko: {
    ...
    attendance: {
      ...
      monthlyStats: "월별 통계",
      monthlyStatsDesc: "해당 월의 전체 근태 통계를 확인하세요",
      workHours: "근무시간",
      overtime: "연장근무",
      rate: "비율",
    },
  ...
  en: {
    ...
    attendance: {
      ...
      monthlyStatsDesc: "View comprehensive attendance statistics for the selected month",
  ...
  vi: {
    ...
    attendance: {
      ...
      monthlyStatsDesc: "Xem thống kê chấm công toàn bộ của tháng đã chọn",
